...
enum class Sprite : int
{
  ...
  SPRITE_DOOR_OPEN_R_1 = 1136,
  SPRITE_DOOR_OPEN_R_2 = 1137,
  SPRITE_DOOR_OPEN_B_1 = 1138,
  SPRITE_DOOR_OPEN_B_2 = 1139,
  SPRITE_DOOR_OPEN_G_1 = 1140,
  SPRITE_DOOR_OPEN_G_2 = 1141,

...
class Actor
{
 public:
  ...
  virtual geometry::Rectangle get_detection_rect([[maybe_unused]] const Level& level) const { return geometry::Rectangle(); }

  geometry::Position position;
  geometry::Size size;

 protected:
  geometry::Rectangle create_detection_rect(const int dx, const int dy, const Level& level) const;
};
